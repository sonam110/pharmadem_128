        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo url('/users') ?>"><?php echo lang('customers') ?></a></li>
              <li class="breadcrumb-item active"><?php echo $Customer->id ?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header d-flex p-0">
                <h3 class="card-title p-3"><?php echo lang('view_customer') ?></h3>
                <ul class="nav nav-pills ml-auto p-2">
					...
					<?php if (hasPermissions('users_edit')): ?>
						<li class="nav-item"><a class="nav-link" href="<?php echo url('customers/edit/'.$Customer->id) ?>"><?php echo lang('edit_user') ?></a></li>
					<?php endif ?>
      			...
      			<table class="table table-bordered table-striped">
      				<tbody>
      					...
      					<tr>
      						...
      						<td><?php echo ($Customer->last_login!='0000-00-00 00:00:00')?date( setting('datetime_format'), strtotime($User->last_login)):'No Record' ?></td>
      					</tr>
