           ...
           <div class="col-md-12" >
               <div class="card">
                   ...
                   <div class="card-body">
                       ...
                       <div class="form-group">
                            <label for="set1_start">Select Projects </label>
                            <span id ="projectDivCorrected"></span>
...
<button type="button" id="fetchDataBCorrecrutton">Fetch Corrected Data</button>
        ...
        $('#solvent').change(function() {
            ...
            if (solvent !== '') {
                $.ajax({
                    ...
                    dataType: 'html',
                    success: function(response) {
                        $('#projectDivCorrected').html(response); // Clear existing options
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for (var i = 0; i < projectsData.length; i++) {
                        ...
                        headerRow.push(projectName + ' (10cmgml Corrected)');
                        headerRow.push(projectName + ' (25cmgml)');
                        headerRow.push(projectName + ' (25cmgml Corrected)');
                        headerRow.push(projectName + ' (50cmgml)');
                        headerRow.push(projectName + ' (50cmgml Corrected)');
