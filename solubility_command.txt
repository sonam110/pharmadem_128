...
df[['Experimental', 'Predicted', 'Corrected Predicted']].to_csv('sonam_predicted_corrected.tsv', sep='\t', index=False)

# Convert ndarray to string
data_str = np.array2string(new_pred_corrected, separator=' ', precision=10, suppress_small=True)
